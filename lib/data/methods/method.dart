...
// method to get the signs for the formula
  ...
  setTrickModel(String sign) {
    return CommonMethods().setTrickModel(sign); // Call setTrickModel from common_methods.dart
  }
...
// Multiplication Table
  TrickModel method6() {
    ...
    answer = toStringValue((n1 * n2));
    addIntOption();
    question = toStringValue(n1) + space + multiSign + space + toStringValue(n2);
...
// Multiply to digit numbers having same tens digit and ones digits' sum is 10
  TrickModel method13() {
    ...
    int createNumber1 = int.parse(toStringValue(n2).substring(0, toStringValue(n2).length - 1));
...
// Multiply by 0.5
  TrickModel method20() {
    ...
    answer = toStringValue((n1 * n2));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + multiSign + space + getSplitString(toStringValue(n2));
    return setTrickModel(multiSign);
  }
...
// Division
  ...
  TrickModel method40() {
    ...
    print("$n1 + $n2");
    int quest = (n1 * n2);
    int solution = quest ~/ n2; // Use integer division operator to get integer solution
...
// addOption(answer); // Add solution as an option
    ...
    question = getSplitString(toStringValue(quest)) + space + divSign + space + getSplitString(toStringValue(n2));
    return setTrickModel(divSign);
  }

// Division by 5
  TrickModel method41() {
    double n1 = (getRandomNumber(level * 25, level * 2) / 5).round() * 5.toDouble();
    double n2 = 5;
    answer = toStringValue(n1 ~/ n2); // Using integer division (~/) to get the quotient
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
    return setTrickModel(divSign);
  }

// Divide by 4
  TrickModel method42() {
    double n1 = (getRandomNumber(level * 20, level * 2) / 4).round() * 4.toDouble();
    double n2 = 4;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 20
  TrickModel method43() {
    double n1 = (getRandomNumber(level * 100, level * 50) / 20).round() * 20.toDouble();
    double n2 = 20;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 50
  TrickModel method44() {
    double n1 = (getRandomNumber(level * 250, level * 10) / 50).round() * 50.toDouble() * 50.toDouble();
    double n2 = 50;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 25
  TrickModel method45() {
    double n1 = (getRandomNumber(level * 125, level * 60) / 25).round() * 25.toDouble();
    double n2 = 25;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 40
  TrickModel method46() {
    double n1 = (getRandomNumber(level * 20, level * 10) / 40).round() * 40.toDouble();
    double n2 = 40;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 0.5
  TrickModel method47() {
    double n1 = (getRandomNumber(level * 2, level * 1) / 0.5).round() * 0.5.toDouble();
    double n2 = 0.5;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 0.2
  TrickModel method48() {
    double n1 = (getRandomNumber(level * 2, level * 1) / 0.2).round() * 0.2.toDouble();
    double n2 = 0.2;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 0.25
  TrickModel method49() {
    double n1 = (getRandomNumber(level * 2, level * 1) / 0.25).round() * 0.25.toDouble();
    double n2 = 0.25;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 15
  TrickModel method50() {
    double n1 = (getRandomNumber(level * 75, level * 35) / 15).round() * 15.toDouble();
    double n2 = 15;
...
// Divide by 6
  TrickModel method51() {
    double n1 = (getRandomNumber(level * 30, level * 15) / 6).round() * 6.toDouble();
    double n2 = 6;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 3
  TrickModel method52() {
    double n1 = (getRandomNumber(level * 15, level * 5) / 3).round() * 3.toDouble();
    double n2 = 3;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 2
  TrickModel method53() {
    double n1 = (getRandomNumber(level * 10, level * 5) / 2).round() * 2.toDouble();
    double n2 = 2;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 8
  TrickModel method54() {
    double n1 = (getRandomNumber(level * 40, level * 20) / 8).round() * 8.toDouble();
    double n2 = 8;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
  ...
  // Divide by 7
  TrickModel method55() {
    double n1 = (getRandomNumber(level * 35, level * 20) / 7).round() * 7.toDouble();
    double n2 = 7;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
// Divide by 9
  TrickModel method56() {
    double n1 = (getRandomNumber(level * 45, level * 20) / 9).round() * 9.toDouble();
    double n2 = 9;
    answer = toStringValue(((n1 / n2)));
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + space + divSign + space + getSplitString(toStringValue(n2));
...
//        addDoubleOption();
    ...
    answer = getSplitString(toStringValue(getFormatValue2(double.parse(answer))));
...
// nth root of 2 between 1 - 100
  ...
  TrickModel method83() {
    double rand = getRandomNumber(level <= 3 ? 15 : level * 3, level).toDouble();
    double n1 = rand * rand;
    double n2 = 2;
    double nthRootValue = nthRoot(n1, n2);
    answer = toStringValue(((nthRootValue * 1000) / 1000).round());
    question = getSupScript(n2.toInt()) + '√' + getSplitString(toStringValue(n1));
...
// nth root of 3 between 1 - 100
  TrickModel method84() {
    double rand = getRandomNumber(level <= 3 ? 5 : level * 2, level).toDouble();
    double n1 = rand * rand * rand;
    double n2 = 3;
    double nthRootValue = nthRoot(n1, n2);
    // answer = toStringValue((n1.round()));
    answer = toStringValue(((nthRootValue * 1000) / 1000).round());
...
// nth root of 5
  TrickModel method86() {
    double rand = getRandomNumber(level <= 3 ? 15 : level * 3, level).toDouble();
    double n1 = rand * rand * rand * rand * rand;
    double n2 = 5;
    double nthRootValue = nthRoot(n1, n2);
    answer = toStringValue(((nthRootValue * 1000) / 1000).round());
    question = getSupScript(n2.toInt()) + '√' + getSplitString(toStringValue(n1));
...
// nth root of 6 between 1 - 100
  TrickModel method87() {
    double rand = getRandomNumber(level <= 3 ? 15 : level * 3, level).toDouble();
    double n1 = rand * rand * rand * rand * rand * rand;
    double n2 = 6;
    double nthRootValue = nthRoot(n1, n2);
    answer = toStringValue(((nthRootValue * 1000) / 1000).round());
    question = getSupScript(n2.toInt()) + '√' + getSplitString(toStringValue(n1));
...
// nth root of 9 between 1 - 100
  TrickModel method88() {
    double rand = getRandomNumber(level <= 3 ? 15 : level * 3, level).toDouble();
    double n1 = rand * rand * rand * rand * rand * rand * rand * rand * rand;
    double n2 = 9;
    double nthRootValue = nthRoot(n1, n2);
    answer = toStringValue(((nthRootValue * 1000) / 1000).round());
    question = getSupScript(n2.toInt()) + '√' + getSplitString(toStringValue(n1));
...
// Percentage
  TrickModel method89() {
    ...
    addDoubleOption();
    question = getSplitString(toStringValue(n1)) + percentageSign + stringOf + getSplitString(toStringValue(n2));
    return setTrickModel('');
  }
...
// Percentage Calculation (Number Range: 1 to 45, Percentage Range: 50%)
  TrickModel method91() {
    ...
    addDoubleOption();
    question = toStringValue(50) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Percentage: 25% Number: 1 to 90
  TrickModel method92() {
    ...
    addDoubleOption();
    question = toStringValue(25) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 90
  TrickModel method93() {
    ...
    addDoubleOption();
    question = toStringValue(20) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 500
  TrickModel method94() {
    ...
    addDoubleOption();
    question = toStringValue(15) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 500
  TrickModel method95() {
    ...
    answer = toStringValue(((((n1 / 10)) / 2)));
    addDoubleOption();
    question = toStringValue(5) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 500
  ...
  TrickModel method96() {
    ...
    addDoubleOption();
    question = toStringValue(4) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 500
  ...
  TrickModel method97() {
    ...
    addDoubleOption();
    question = toStringValue(2) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 500
  TrickModel method98() {
    ...
    answer = toStringValue(((((n1 / 100)) / 2)));
    addDoubleOption();
    question = toStringValue(0.5) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 120
  TrickModel method99() {
    ...
    answer = toStringValue(getFormatValue2(step2));
    addDoubleOption();
    question = toStringValue(150) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
  // Percentage: 200%
// Number: 1 to 180
  ...
  TrickModel method100() {
    ...
    answer = toStringValue((n1 * 2));
    addDoubleOption();
    question = toStringValue(200) + percentageSign + stringOf + getSplitString(toStringValue(n1));
...
// Number: 1 to 220
  ...
  TrickModel method101() {
    double n1 = getRandomNumber(level <= 3 ? 40 : level * 8, level * 4).toDouble();
    answer = toStringValue(((n1 / 4) * 10));
    addDoubleOption();
    question = toStringValue(250) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel(percentageSign);
  }
...
// Number: 1 to 280
  TrickModel method102() {
    ...
    addDoubleOption();
    question = toStringValue(300) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 400
  TrickModel method103() {
    double n1 = getRandomNumber(level <= 3 ? 40 : level * 13, level * 4).toDouble();
    answer = toStringValue(((n1 * 5)));
    addDoubleOption();
    question = toStringValue(500) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
...
// Number: 1 to 70
  TrickModel method104() {
    ...
    addDoubleOption();
    question = toStringValue(75) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel(percentageSign);
  }
...
// Number: 1 to 700
  TrickModel method105() {
    double n1 = getRandomNumber(level <= 3 ? 40 : level * 30, level * 10).toDouble();
    answer = toStringValue(((((n1 / 4) * 3)) * 10));
    addDoubleOption();
    question = toStringValue(750) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel(percentageSign);
  }
...
// Number: 1 to 80
  TrickModel method106() {
    ...
    addDoubleOption();
    question = toStringValue(40) + percentageSign + stringOf + getSplitString(toStringValue(n1));
    return setTrickModel('');
  }
