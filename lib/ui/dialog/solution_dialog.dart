  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Column(
          ...
          children: [
            getCustomFont('Solution', 22, getFontColor(context), 1, fontWeight: FontWeight.w700),
            Container(
              child: HtmlWidget(decode(DataFile.getTrickRulesSolution()[dummyModel.formulaId - 1]),
                  textStyle: TextStyle(
                    color: color,
                  )),
