    ...
    return StatefulBuilder(builder: (context, setState) {
      return Dialog(
        ...
        child: Container(
          ...
          decoration: getDefaultDecoration(radius: radius, bgColor: getCardColor(context)),
          child: Column(
            ...
            children: [
              ...
              getTextWidget(S.current.giveYourOpinion, 20, getFontColor(context), fontWeight: FontWeight.w700, textAlign: TextAlign.center),
              10.verticalSpace,
              getTextWidget(S.current.makeBetterMathGoal, 15, getFontColor(context), fontWeight: FontWeight.w400, textAlign: TextAlign.center),
              50.verticalSpace,
              RatingBar(
                  itemCount: 5,
