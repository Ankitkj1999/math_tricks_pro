...
class _QuizPage extends State<QuizPage> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<QuizProvider>(
      init: QuizProvider(dummyModel: dummyModel, context: context, color: color),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  // TODO: Add animation in the text
                                  // tried getCustomScaleAnimatedFont but it is not working

                                  getCustomFont(getQuestionType(quizProvider, quizProvider.quizModel.value.question), 28, getFontColor(context), 1,
                                      fontWeight: FontWeight.w700, textAlign: TextAlign.end),
                                  Visibility(
                                    child: 10.horizontalSpace,
                                    visible: quizProvider.type.value == keyboardView,
                                  ),
                                  Visibility(
                                    child: Flexible(
                                      child: commonTextFiled(quizProvider.textEditingController, context, (value) {
                            ...
                            Expanded(
                              child: AnswerView(
                                  ...
                                  function: (answer) {
                                    quizProvider.submitAnswer(answer, quizProvider.type.value == trueFalseView);
                                  },
