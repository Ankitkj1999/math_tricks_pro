            ...
            child: Column(
              children: [
                ...
                Expanded(
                    child: HeaderWidget(
                        tuple3: tuple3,
                        icon: DataFile.getCategoryList()[dummyModel.categoryId].icon,
                        childWidget: Container(
                          height: double.infinity,
                          margin: EdgeInsets.only(top: 80.h),
                          child: Column(
                            children: [
                              getCustomFont(S.current.totalLevel + ' =  $TOTAL_LEVEL_SIZE', 25, Colors.white, 1, fontWeight: FontWeight.w700),
                              7.verticalSpace,
                              getCustomFont(S.current.totalQuestions + ' =  ${TOTAL_LEVEL_SIZE * DEFAULT_QUESTION}', 25, Colors.white, 1,
                              ...
                              Expanded(
                                ...
                                decoration:
                                    getDefaultDecorationWithSide(bgColor: getCardColor(context), radius: 20.r, isTopLeft: true, isTopRight: true),
                                child: Obx(() {
