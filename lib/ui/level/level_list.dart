...
class LevelList extends StatelessWidget {
  ...
  LevelList({required this.list, required this.animationController, required this.color, required this.dummyModel});
  ...
  Widget build(BuildContext context) {
    ...
    var widthItem = (MediaQuery.of(context).size.width - ((_crossAxisCount - 1) * _crossAxisSpacing)) / _crossAxisCount;
      ...
      children: List.generate(list.length, (index) {
        final Animation<double> animation = Tween<double>(begin: 0.0, end: 1.0).animate(
          CurvedAnimation(
            ...
            curve: Interval((1 / list.length) * index, 1.0, curve: Curves.fastOutSlowIn),
          ),
        );
        ...
        return buildAnimatedItem(
            ...
            InkWell(
              child: Container(
                height: height,
                decoration: getDefaultDecoration(radius: 28.r, borderColor: getFontColor(context), bgColor: getCardColor(context)),
                child: Column(
              ...
              onTap: () {
                ...
                Get.toNamed(KeyUtil.quizPage, arguments: Tuple2(dummyModel, color));
              },
            ));
      }),
    );
  ...
  Widget buildAnimatedItem(BuildContext context, int index, Animation<double> animation, Widget widget) =>
