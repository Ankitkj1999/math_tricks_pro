...
class _ReminderPage extends State<ReminderPage> {
  ...
  // function to check if the alarm permission already granted or not
  void checkAlarmPermission() async {
  ...
  Future<void> getAlarmPermission(
  ...
  Future<void> _scheduleWeeklyMondayTenAMNotification(int day, int id) async {
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
        id,
        'Maths Trick - Practice Maths and become a Math Master',
        'What is this',
        _nextInstanceOfMondayTenAM(day),
        const NotificationDetails(
          android: AndroidNotificationDetails('com.cheetah.math.trick.pro',
