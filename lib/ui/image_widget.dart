            ...
            child: Column(
              children: [
                  ...
                  child: ListView(
                    ...
                    children: [
                      data.isEmpty
                          ? Container()
                          : Container(
                              child: HtmlWidget(decode(data), textStyle: TextStyle(color: color.darkColor, fontSize: 18.sp)),
                        ...
                        builder: (context, snapshot) {
                          ...
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            return Container(
                              ...
                              child: Center(
                                child: Image.asset('${assetTrickImages}${snapshot.data}'),
                              ),
                            );
                          }
                          return Container();
                ...
                getCommonButton(
                    title: S.current.go,
                    function: () {
                      Get.toNamed(KeyUtil.levelPage, arguments: widget.colorTuple);
                    },
                    color: color.darkColor)
              ],
            ),
