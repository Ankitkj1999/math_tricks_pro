...
class _FeedbackScreen extends State<FeedbackScreen> {
        ...
        body: SafeArea(
          child: Column(
            ...
            children: [
              ...
              getCommonButton(
                  title: S.current.submitFeedback,
                  function: () async {
                    if (rate >= 3) {
                      String feedback = "";
                      ...
                      final Email email = Email(body: feedback, subject: 'App Feedback', isHTML: false, recipients: ['ankit.k.j1999@gmail.com']);
  ...
  Expanded buildExpandedData(EdgeInsets edgeInsets, double starSize, int selection, BuildContext context) {
    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          20.verticalSpace,
          getCustomFont(S.current.giveFeedback, 25, fontColor, 1, fontWeight: FontWeight.w700),
          7.verticalSpace,
          getTextWidget(S.current.giveYourFeedback, 16, fontColor, fontWeight: FontWeight.w400),
          60.verticalSpace,
          getCustomFont(S.current.areYouSatisfied, 16, fontColor, 1, fontWeight: FontWeight.w500),
          30.verticalSpace,
          RatingBar(
              itemCount: 5,
          ...
          70.verticalSpace,
          getCustomFont(S.current.tellUsImprovements, 16, fontColor, 1, fontWeight: FontWeight.w500),
          30.verticalSpace,
          getDefaultTextFiled(context, S.current.writeYourFeedback, feedbackController, fontColor, Colors.black, minLines: true)
        ],
      ),
      flex: 1,
    );
