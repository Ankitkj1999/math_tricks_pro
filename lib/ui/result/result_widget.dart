              ...
              children: [
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    40.verticalSpace,
                    getCustomFont(S.current.score + ': ${dataModel.score!}', 20, getFontColor(context), 1, fontWeight: FontWeight.w700),
                    15.verticalSpace,
                    getCustomFont(S.current.bestScore + ': ${dataModel.highScore!}', 20, getFontColor(context), 1, fontWeight: FontWeight.w700),
                    30.verticalSpace,
                    Row(
                      ...
                      children: <Widget>[
                        for (int i = 0; i < 3; i++)
                          Padding(
                            ...
                            child: Image.asset(
                              (dataModel.progress! - 1) < (i) ? '${assetPath}star.png' : '${assetPath}fill_star.png',
                              height: 60.h,
                              width: 60.h,
                            ),
                          )
                ...
                30.verticalSpace,
                getCommonButton(
                    title: dataModel.level_no! < TOTAL_LEVEL_SIZE ? S.current.next : 'Done',
                    function: () {
